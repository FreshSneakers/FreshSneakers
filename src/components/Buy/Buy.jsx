...
import { filterProductBuy, getProducts } from "../../services/ProductService";
import "./Buy.css";
              ...
              <div className="card__results">
                ...
                <div className="card__filter">
                  ...
                  <select>
                    ...
                    <option onChange={onChange} value={search}>Price low</option>
                    <option onChange={onChange} value={search}>Price high</option>
                  </select>
                </div>
              </div>
